...
Imagine Markdown grew up, went to design school, and now runs a creative studio.
...
* new to POML
* new to open source
* or just vibing by and curious

Seriously, come help!
Open a PR, file an issue, add test cases, tweak docs — we’re chill, fast to respond, and very “let’s build cool stuff together.”
Think early-20s-dev-energy: coffee, music, excitement, and lots of emojis 💫
