...
- 3️⃣ Extended runway (Δ→ 82%): Extended tags (`<op>/<figure>/<text>/<data>`), strict validation (names/JSON args/alt/mime/size/attrs), richer allowlists + aliases/build-tags, embedded-tag extraction flag, mixed/media/text-escape/data goldens. Remaining: proposal deltas (custom media/data nuances, stricter enums) — see plan below.
