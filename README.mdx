...
POML is a structured, spec-driven language for orchestrating AI prompts. It's declarative, expressive, type-safe, and multi-modal — making it far easier to maintain than a giant prompt blob. This SDK brings POML's power to Go with a focus on spec compliance, safety, and developer experience.
...
func main() {
    doc, _ := poml.ParseFile("prompt.poml")
