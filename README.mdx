...
> ⚙️ Premium tooling (MCP server, VS Code extension, OTLP tracing, renderers) now lives in [`poml-horse`](https://github.com/atlas-foundry/poml-horse). This repo keeps the OSS parity surface aligned with `poml-lang/poml`.
